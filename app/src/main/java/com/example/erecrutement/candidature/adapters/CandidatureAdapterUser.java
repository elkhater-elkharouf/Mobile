...
public class CandidatureAdapterUser extends RecyclerView.Adapter<CandidatureAdapterUser.ViewHolder> {

    private List<Candidature> candidatures;
    private CandidatureListUserFragment candidatureListFragment;

    public CandidatureAdapterUser(List<Candidature> candidatures, CandidatureListUserFragment candidatureListFragment) {
        this.candidatures = candidatures;
        this.candidatureListFragment = candidatureListFragment;
    }

    public void setData(List<Candidature> candidatures) {
        this.candidatures = candidatures;
    }
